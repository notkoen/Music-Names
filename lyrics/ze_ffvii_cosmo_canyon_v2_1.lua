GM.ZELyrics = {
	...
	["ffvii_granitev2.mp3"] = {
		{time = 42.8, text = "You can hide your eyes, you can dim the lights, but they are watching"},
		{time = 48.0, text = "This is a new time with a different kind, they are the future"},
		{time = 53.1, text = "The only one"},
		{time = 59.1, text = "It's a final call for the setting sun when they get closer"},
		{time = 64.5, text = "And with a fall from grace they will be done, the show is over"},
		{time = 69.5, text = "It's a new dawn"},

		{time = 86.7, text = "Just leave this place behind"},
		{time = 89.4, text = "I'll clear your bloodshot mind"},
		{time = 92.0, text = "They only wanted your life on demand"},
		{time = 97.0, text = "This is a better way"},

		{time = 119.8, text = "They were standing by, no time to hide, no meeting halfway"},
		{time = 125.4, text = "You were sucking life through the needle's eye, this is a new day"},
		{time = 130.4, text = "And they have won"},
		{time = 136.2, text = "We will surrender now or be outdone, left in the open"},
		{time = 141.8, text = "It's the cooling of the horizon, they are the future"},
		{time = 147.0, text = "The future"},
		{time = 158.2, text = "(The future)"},
		{time = 169.5, text = "When all your fears combined"},
		{time = 172.3, text = "The manifest was refined"},
		{time = 174.8, text = "I know you really tried to understand"},
